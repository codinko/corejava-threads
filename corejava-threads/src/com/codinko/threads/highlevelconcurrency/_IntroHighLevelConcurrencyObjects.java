 ...
 * 
 * So far, we covered low-level APIs that have been part of the Java platform
 * from the very beginning. These APIs are adequate for very basic tasks, but
 * higher-level building blocks are needed for more advanced tasks. This is
 * especially true for massively concurrent applications that fully exploit
 ...
 * implemented in the new java.util.concurrent packages. There are also new
 * concurrent data structures in the Java Collections Framework.
 * 
 */
public class _IntroHighLevelConcurrencyObjects {
	/**
	 * 
	 ...
	 * 
	 * Concurrent collections: make it easier to manage large collections of
	 * data, and can greatly reduce the need for synchronization.
	 * 
